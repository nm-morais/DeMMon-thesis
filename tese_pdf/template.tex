...
\title[Edge DeMon \\ Edge Decentralized Monitoring]{Edge DeMon \\ Edge Decentralized Monitoring}

% Autor
% use [f] for female and [m] for male
\authorname[m]{Nuno Miguel Cadima Vasconcelos Morais}{Nuno Miguel Cadima Vasconcelos Morais}
\authordegree{Degree in Computer Science and Engineering}

...
There are two main architectures used to distribute resources in a system, \textbf{centralized} and \textbf{decentralized}. \todo{preciso de inventar chacho para nao ficar uma frase}

...
\subsection{Query Dissemination Techniques}
...
There are three main architectures to distribute resources in a system, \textbf{centralized}, \textbf{distributed over a Distributed Hash Table (DHT)} and \textbf{Distributed over an Unstructured Overlay} \todo[]{meter mais pomposo}

...
However, single tenancy goes against most distributed systems today, which are inherently \emph{shared} by multiple tenants, both on private and public clouds \cite{mace2015retro}.

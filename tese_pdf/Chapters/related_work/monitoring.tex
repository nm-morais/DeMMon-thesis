In this section we will cover \textbf{resource monitoring}, which consists in tracking the state of a certain aspect of a system, such as the device status, the capacity of links between devices, the status of available resources in a given zone of the system, among others. 

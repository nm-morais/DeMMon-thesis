...
%%     inside braces must correspond to a file with an extension
...
\ntaddfile{chapter}{go_babel}
\ntaddfile{chapter}{demmon}
\ntaddfile{chapter}{benchmark}
